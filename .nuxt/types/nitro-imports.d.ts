declare global {
  ...
  const clearUserSession: typeof import('../../server/utils/jwt').clearUserSession
  ...
  const getUserSession: typeof import('../../server/utils/jwt').getUserSession
  ...
  const setUserSession: typeof import('../../server/utils/jwt').setUserSession
  const signUserToken: typeof import('../../server/utils/jwt').signUserToken
  ...
  const verifyUserToken: typeof import('../../server/utils/jwt').verifyUserToken
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'C:/Users/inoko/Desktop/shortlink/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'C:/Users/inoko/Desktop/shortlink/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { signUserToken, verifyUserToken, setUserSession, getUserSession, clearUserSession } from 'C:/Users/inoko/Desktop/shortlink/server/utils/jwt';
export { default as prisma } from 'C:/Users/inoko/Desktop/shortlink/server/utils/prisma';